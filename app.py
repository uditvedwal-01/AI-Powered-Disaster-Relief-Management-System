...
DISASTERS_ROOT = BASE_DIR / "Disasters"
...
class Disaster(db.Model):
	...
	def get_tenant_prefix(self):
		"""Generate a unique prefix for this disaster's tables"""
		return f"disaster_{self.DisasterID}"
...
def clear_tenant_cache():
	"""Clear the tenant model cache"""
	global _tenant_model_cache
	_tenant_model_cache.clear()
	print("Tenant model cache cleared")
